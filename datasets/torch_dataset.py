        ...
        for set_i, (set_name, dataset) in enumerate(self._data.items()):  # type: ignore
            ...
            while start_index < total_examples:
                ...
                yield {
                    "x": batch["inputs"],
                    "y": batch["labels"],
                    "aug_puzzle_idx": batch["puzzle_identifiers"]
                }
        ...
        for set_name, dataset in self._data.items():  # type: ignore
            ...
            while start_index < group_order.size:
                ...
                yield {
                    "x": batch["inputs"],
                    "y": batch["labels"],
                    "aug_puzzle_idx": np.expand_dims(batch["puzzle_identifiers"], -1)
                }
...
def get_data_loader(data_path, split, batch_size):
